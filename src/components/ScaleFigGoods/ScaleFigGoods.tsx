    ...
    return (
        <div className="w-full flex flex-col items-center mt-10">
            <div className="group overflow-hidden 
                relative featured-item w-full h-1/4 border-2"
            >
                <Link href='/' className="relavtive
                    ...
                    ">
                    <img className="max-w-full max-h-full" src="https://theme.hstatic.net/1000160337/1000885200/14/home_bannerfull.jpg?v=299" />
                </Link>
            </div>
            <h1 className="text-2xl font-bold p-2">Scale Figure</h1>
            <p className="font-light">Sản phẩm được chế tác theo tỉ lệ chuẩn</p>
