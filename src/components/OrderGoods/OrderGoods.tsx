...
const OrderGoods = () => {
    return (
        <div className="w-full flex flex-col items-center mt-10">
            <h1 className="text-2xl font-bold p-2">Sản phẩm Order</h1>
            <p className="font-light">Những sản phẩm đã hoặc sắp phát hành và cần đặt trước</p>
            ...
            <div className="w-full h-auto md:flex md:flex-row flex flex-col justify-evenly mt-10">
                ...
                >
                    ...
                    ">
                        <img className="group-hover:scale-125 transition-all duration-500 ease-in-out max-w-full max-h-full

                        
                    
                        
                        " src="https://theme.hstatic.net/1000160337/1000885200/14/home_collection_1_banner.jpg?v=299" />
                    </Link>
                </div>
